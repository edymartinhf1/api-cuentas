...
@Component
public class MonederoMovilStrategy implements MonederoStrategy{
    @Override
    public Mono<ResponseMonedero> registrarMonedero(KafkaMessageSender kafkaProducer, Cliente clienteNuevo, CuentaDao cuenta, MonederoMovilPost monederoMovilPost) {
